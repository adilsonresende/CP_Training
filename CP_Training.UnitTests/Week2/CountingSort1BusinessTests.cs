...
{
    public class CountingSort1BusinessTests
    {
        private CountingSort1Business _countingSort1Business;
        [SetUp]
        public void Setup()
        {
            _countingSort1Business = new CountingSort1Business();
        }

        [Test]
        public void CountingSort_WhenCalled_ReturnsNumberOfOccorencies()
        {
            ...
            List<int> result = _countingSort1Business.CountingSort(input);
